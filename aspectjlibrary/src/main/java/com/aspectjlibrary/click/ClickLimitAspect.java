 ...
 * 可修改间隔时间和是否需要默认的防抖动处理，参考ClickLimit
 */
@Aspect
    ...
    public void processJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (!canClick(lastClickTime, intervalTime)){
                ...
                //可通过反射自定义提示信息，（写在对应的activity里）
                Toast.makeText(view.getContext(), "程序正在运行，不要多次点击", Toast.LENGTH_SHORT).show();
                return;
