...
public abstract class LazyPagerAdapter<T> extends PagerAdapter {
     ...
     * @param container {@link com.li.androidprojecttext.view.LazyViewPager}
     ...
     * to prevent {@link com.li.androidprojecttext.view.LazyViewPager#onPageScrolled(int, float, int)} not working when the offset of {@link com.li.androidprojecttext.view.LazyViewPager} is too big
     */
    @Override
