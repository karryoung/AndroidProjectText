...
import com.li.androidprojecttext.kotlin.view.recyclerview.MultipleType
...
abstract class CommonAdapter<T>(var mContext: Context, var mData: ArrayList<T>,//条目布局
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        //绑定数据
        binData(holder, mData[position], position)
        //条目点击事件
     ...
     * 将必要参数传递出去
     */
    protected abstract fun binData(holder: ViewHolder, data: T, position: Int)
