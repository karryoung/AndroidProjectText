...
object DisplayManager {
     ...
     * 输入UI图的尺寸，输出实际的px
     */
    fun getRealWidth(size: Int): Int? {
        return getRealWidth(size, STANDARD_WIDTH.toFloat())
    }
     ...
     * @return
     */
    fun getRealWidth(size: Int, toFloat: Float): Int? {
        return (size / toFloat * getScreenWidth()!!).toInt()
    }
